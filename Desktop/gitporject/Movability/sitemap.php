        ...
        <span style="background-color:white" class="icon-bar"></span>                        
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>&nbsp;</li>
                    <li class="inactive"><a href="#"><span class="glyphicon glyphicon-th-list"></span> Περιεχόμενα</a></li>
            ...
            <div class="col-md-9 text-left">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page">Περιεχόμενα</li>
                    </ol>
                </nav>
                <h4 style="background-color:lightslategrey;color:white;font-weight:bold;padding:3px 3px 3px 3px">&nbsp;Περιεχόμενα</h4>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8"><img src="sitemap.png" alt="sitemap" style="width: 100%; height: 50%"/></div>
                        </div>
                    </div>
            </div>
        </div>
