        ...
        <div class="row content">
            <div class="col-sm-2 sidenav">
               <br>
                ...
                <p><a href="ReportDisplayτ.php" style="font-weight:bold;text-decoration: none">Αναφορές ραμπών</a></p>
            ...
            <div class="col-sm-9 text-left">
                ...
                <h4 style="background-color:lightslategrey;color:white;font-weight:bold;padding:3px 3px 3px 3px">&nbsp;Στοιχεία επικοινωνίας</h4>
                <Br>
                <h4 style="color:lightslategrey;font-weight:bold">Μέλη ομάδας</h4>
                <div class="row" >
                    <div class="col-md-4">
                        <h4 style="color:lightslategrey;"><span class="glyphicon glyphicon-user"></span> Ζώγας Γεώργιος</h4>
                        <h4 style="color:lightslategrey;"><span class="glyphicon glyphicon-envelope"></span> Something@Something.com</h4>
                        <br>
                    </div>
                    <div class="col-md-4">
                        <h4 style="color:lightslategrey;"><span class="glyphicon glyphicon-user"></span> Ζαφειρόπουλος Δημήτρης</h4>
                        <h4 style="color:lightslategrey;"><span class="glyphicon glyphicon-envelope"></span> Something@Something.com</h4>
                    </div>
                    <div class="col-md-4">
                        <h4 style="color:lightslategrey;"><span class="glyphicon glyphicon-user"></span> Καλύβας Κωνσταντίνος</h4>
                        <h4 style="color:lightslategrey;"><span class="glyphicon glyphicon-envelope"></span> Something@Something.com</h4>
                        <br>
                    </div>
                </div>
